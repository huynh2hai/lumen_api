...
class AuthorsRatingsControllerTest extends TestCase
{
    ...
    {
        $this->post('/authors/9999/ratings', [], ['Accept' => 'application/json']);
    ...
    public function destroy_can_delete_an_author_rating()
    {
        ...
        $this->delete("/authors/{$author->id}/ratings/{$ratingToDelete->id}")
            ->seeStatuscode(204);
    ...
    /** @test */
    public function destroy_fails_when_rating_is_invalid()
    {
        $author = factory(\App\Author::class)->create();

        $this->delete("/authors/{$author->id}/ratings/999999")
            ->seeStatuscode(404);
    }
